...
begin
  ...
  DataModule2.ZQuery1.SQL.Add('insert into kustomer values(null,"'+Edit1.Text+'","'+Edit2.Text+'","'+Edit3.Text+'","'+Edit4.Text+'","'+Edit5.Text+'")');
...
begin
  ...
  begin
  ShowMessage('Nik kustomer'+Edit1.Text+' Tidak Ada Perubahan');
  end else
  begin
  DataModule2.ZQuery1.SQL.Clear;
  DataModule2.ZQuery1.SQL.Add('update kustomer set Nik = "'+Edit1.Text+'", Name = "'+Edit2.Text+'", Telp = "'+Edit3.Text+'", Email = "'+Edit4.Text+'",Alamat = "'+Edit5.Text+'" here Id = "'+a+'"');
  DataModule2.ZQuery1.ExecSQL;
